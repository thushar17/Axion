...
import { getRooms, createRoom, deleteRoom, leaveRoom, renameRoom } from "../services/room.service";
import { useState } from "react";
import { muteRoom, archiveRoom } from "../services/auth.service";
...
type Props = {
    ...
    mutedRoomIds: string[]
    setMutedRoomIds: React.Dispatch<React.SetStateAction<string[]>>
    archivedRoomIds: string[]
    setArchivedRoomIds: React.Dispatch<React.SetStateAction<string[]>>
